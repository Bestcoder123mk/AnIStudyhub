...
import { Star, Check, X, Eye, EyeOff, FlaskConical, Dna, Zap } from "lucide-react";
    ...
    <div className="space-y-5">
      <div className="animate-float-up">
        ...
        <p className="mt-1 text-sm text-muted-foreground md:text-base">
          28 two-mark questions · Reveal model answers · Self-grade to earn XP
        </p>
      </div>
