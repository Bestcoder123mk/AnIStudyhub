...
const SKILLS: SkillNode[] = [
  ...
  { id: "science-mcq", label: "Science MCQ Master", desc: `Access ${MCQS.length} Science MCQs`, cost: 50, icon: "⚛️", deps: ["root"], track: "science" },
  { id: "ssc-mcq", label: "SSC Explorer", desc: `Access ${SSC_MCQS.length} SSC MCQs`, cost: 50, icon: "🌏", deps: ["root"], track: "ssc" },
