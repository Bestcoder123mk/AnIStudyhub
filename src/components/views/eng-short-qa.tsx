...
import { Star, Eye, EyeOff, BookOpen, Notebook, Sparkles, Brain } from "lucide-react";
...
export function EngShortQaView() {
  ...
  const toggleReveal = (qa: ENGQA) => {
    ...
    if (!wasRevealed && !awarded.has(qa.id)) {
      revealQA("english", "short", qa.marks);
    ...
    <div className="space-y-5">
      <div className="animate-float-up">
        ...
        <p className="mt-1 text-sm text-muted-foreground md:text-base">
          {ENG_SHORT_QA.length} two &amp; three-mark questions · Reveal model answers as you go
        </p>
      </div>
