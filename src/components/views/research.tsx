                    ...
                    return (
                      <li key={s.id} className="rounded-lg border bg-muted/20 p-3">
                        <div className="flex items-start gap-2">
                          ...
                          <Button size="icon" variant="ghost" className="size-7 shrink-0 text-muted-foreground hover:text-rose-400" onClick={() => deleteSource(s.id)} aria-label="Delete source">
                    ...
                    return (
                      <li key={n.id} className="rounded-lg border bg-muted/20 p-3">
                        <div className="flex items-start gap-2">
                          ...
                          <Button size="icon" variant="ghost" className="size-7 shrink-0 text-muted-foreground hover:text-rose-400" onClick={() => deleteNote(n.id)} aria-label="Delete note">
                            <Trash2 className="size-3.5" />
                          </Button>
                        </div>
                      </li>
