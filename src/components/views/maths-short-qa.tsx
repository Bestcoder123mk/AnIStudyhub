...
export function MathsShortQaView() {
  ...
  const handleRecallScore = (qa: MATHSQA, scored: number) => {
    recordRecall("maths", qa.ch, qa.marks, scored);
    ...
    <div className="space-y-5">
      <div className="animate-float-up">
        ...
        <p className="mt-1 text-sm text-muted-foreground md:text-base">
          {MATHS_SHORT_QA.length} two- & three-mark questions · Reveal model answers as you go
        </p>
      </div>
                  ...
                  <>
                    ...
                    {isRevealed && (
                      <div className="animate-float-up space-y-2">
                        <div className="rounded-lg border border-border bg-muted/40 p-3 text-sm leading-relaxed font-mono">
