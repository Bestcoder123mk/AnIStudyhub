  ...
  return (
    <Card
      className={`glass relative overflow-hidden transition-all ${
        unlocked ? "ring-1 ring-amber-400/50 shadow-md" : "opacity-60"
      }`}
    >
      <CardContent className="py-4 flex flex-col items-center text-center">
        ...
        <div
          ...
          style={unlocked ? { filter: "drop-shadow(0 0 12px oklch(0.8 0.15 80 / 55%))" } : undefined}
        >
          {a.icon}
        </div>
        ...
        {unlocked && (
          <div className="mt-2 text-[10px] uppercase tracking-wider text-amber-600 dark:text-amber-300 font-semibold">
            ✓ Unlocked
          </div>
        )}
      </CardContent>
