...
// Maths, English, Sanskrit — new triptych-panel exhibits (13 + 17 + 12 = 42 chapters)
import { MATHS_EXHIBITS } from "./maths-exhibits";
import { ENGLISH_EXHIBITS } from "./english-exhibits";
import { SANSKRIT_EXHIBITS } from "./sanskrit-exhibits";

// Ordered by chapter — Science first (14), then SSC (20), then
// Maths/English/Sanskrit (13+17+12 = 42) — full coverage across all 5 subjects.
