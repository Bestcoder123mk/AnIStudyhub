  ...
  return (
    <div className="fixed inset-0 z-[85] bg-background/95 backdrop-blur-md flex flex-col animate-float-up">
      ...
      <div className="flex items-center gap-3 px-4 sm:px-6 py-3 border-b border-border glass-strong">
        <button
          onClick={onClose}
          className="press-scale flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition px-3 py-1.5 rounded-lg hover:bg-muted"
        >
        ...
        <button
          onClick={onClose}
          className="press-scale p-2 rounded-lg hover:bg-muted transition text-muted-foreground hover:text-foreground"
          aria-label="Close"
        >
          <X className="size-5" />
        </button>
          ...
          <div className="mt-8 pt-4 border-t border-border flex items-center justify-between gap-3">
            ...
            {data.onContinueTour ? (
              <button
                ...
                className="tap-lift px-4 py-2 rounded-xl text-xs font-semibold text-white transition hover:opacity-90 flex items-center gap-1.5"
