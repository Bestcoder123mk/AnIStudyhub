...
import { EXTRA_ENG_MCQS, EXTRA_ENG_SHORT_QA, EXTRA_ENG_LONG_QA } from "./expansion-english";
...
export interface ENGMCQ {
  ...
  ans: number;
  exp: string;
  /** Board-exam-pattern question, written in the style of CBSE Class 10 English papers — not a literal transcription of an official paper. */
  pyq?: boolean;
}
...
export const ENG_CHAPTERS: ENGChapter[] = [
  {
    ...
    keypts: [
      ...
      "The reader knows the postmaster arranged the money, but Lencho never suspects it — this dramatic irony is what makes his angry second letter both funny and quietly tragic.",
      "Lencho's total faith in God contrasted with his thin trust in real people is the story's real point — he assumes the humans who helped him must be thieves.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Mandela's speech deliberately widens from 'I' (his own inauguration) to 'we' (thousands of unnamed South Africans) — even his greatest personal triumph is framed as belonging to a movement.",
      "The 'twin obligations' — to family and to one's people — are left unresolved, not neatly settled; Mandela is honest that pursuing freedom for millions cost him closeness with his own family.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "The seagull's fear isn't really about flying — it's about risking failure; he only flies because hunger overrides fear, a quiet point about necessity pushing us past our limits.",
      "'The Black Aeroplane' deliberately never reveals who or what saved the pilot — the ambiguity is the point, about reaching for the inexplicable when facing mortal danger.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Anne's diary is addressed to 'Kitty' as if to a real friend — this framing device is exactly what lets her be more honest than she can be with people actually around her.",
      "Anne turning a punishment essay into a clever, witty piece (told from a duckling's point of view) shows resilience — she isn't cowed by punishment, she outsmarts it.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "The three sketches (baker, Coorg, Assam tea) all use small, everyday detail rather than grand history — the implicit argument is that India's diversity lives in local, lived traditions.",
      "'A Baker from Goa' carries a nostalgic, elegiac tone signalling the pader's way of life is fading even as the essay describes it — description with an undercurrent of loss.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Maxwell writes about Mijbil almost as a human character with a distinct personality — that choice, not otters being inherently endearing, is what makes readers connect with him specifically.",
      "Londoners unable to identify what kind of animal Mijbil is highlights how exotic and unfamiliar he is outside his natural context — indirectly emphasising the author's close bond with him.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Valli's secret saving for months is really a story about a child's yearning for independence in an otherwise very restricted small-village life — a small adventure in absolute terms, huge for an eight-year-old.",
      "Valli hiding both her fear and her adventure from the adults afterward is the story's quiet theme — self-reliance, once tasted, doesn't need an audience to validate it.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Kisa Gotami's mustard-seed search is a teaching device, not a literal quest — the Buddha already knows she'll fail, so she can discover through direct experience that death is universal.",
      "The chapter's method (guided experience over direct instruction) reflects Buddhist thought: insight-based understanding is more transformative than being simply told a fact.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Chekhov's comedy comes from the mismatch between the seriousness of a marriage proposal and the pettiness of what actually consumes the characters' energy — a strip of land, whose dog is faster.",
      "The ending — Chubukov forcing the couple together mid-argument — is deliberately anticlimactic, Chekhov's final joke that the proposal itself mattered far less than the surrounding chaos.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "In 'Fire and Ice', fire (desire) and ice (hatred) are opposite forces shown to be equally capable of ending the world — the poem's brevity itself reinforces how casually devastating either can be.",
      "'A Tiger in the Zoo' builds its force through contrast alone — alternating the caged tiger's diminished present with imagined glimpses of wild power, letting the juxtaposition make the argument.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Mrs Pumphrey's excessive indulgence of Tricki is exactly what makes him sick, while the vet's plain, disciplined regime — the opposite of indulgence — is what cures him.",
      "The title 'A Triumph of Surgery' is ironic since no surgery happens at all — the irony pokes fun at assuming anything serious must require something as dramatic as an operation.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Nothing external forces the thief to return the money — no one has caught him — his conscience alone, newly awakened by Anil's trust, makes him change course.",
      "The specific skills Anil teaches (cooking, writing his name, sums) aren't ordinary charity — they give the thief lasting value and independence, which is why trust from Anil feels different from stealing from anyone else.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Ausable's real skill isn't gadgets or gunplay but quick, convincing improvisation under real danger — a deliberately quieter, more believable kind of heroism than the spy genre usually offers.",
      "Max's fatal leap onto a non-existent balcony only works because the story ensures he has no way to verify Ausable's claim in the moment — his own fear becomes the tool of his downfall.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Horace Danby's crime is oddly disciplined — funding a harmless book-collecting hobby rather than any lavish need — which is exactly what makes him easy to sympathise with despite being a thief.",
      "The title cuts two ways: Horace has to trust the woman to get the safe combination, while his whole profession (safe-making) is built on being trusted — the same vulnerability that undoes him.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Wells inverts expectation almost immediately — invisibility should make everything easy, but instead it isolates Griffin completely, unable to be clothed, warmed, or recognised by anyone.",
      "That an ordinary dog can track and expose Griffin despite his invisibility is the story's pointed irony — outsmarting sight doesn't make you undetectable to smell.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "The essay traces a repeatable arc — curiosity becomes structured inquiry becomes genuine contribution — a case study in how scientific habits of mind develop from ordinary childhood interest.",
      "Ebright's mother supports his interests with resources and encouragement rather than directing the outcome — the essay implies open-ended support, not pressure, is what let his curiosity become real skill.",
    ],
    formulas: "",
    exam: [
  ...
  },
  {
    ...
    keypts: [
      ...
      "Mathilde's unhappiness is self-inflicted, not circumstantial — she has a comfortable life but suffers from measuring herself against a wealth and status she doesn't have.",
      "The final twist — the necklace was fake all along — is devastating because it retroactively makes the Loisels' entire decade of poverty pointless, exposing Mathilde's value system as hollow from the start.",
    ],
    formulas: "",
    exam: [
...
const BASE_ENG_MCQS: ENGMCQ[] = [
  ...
  // ── PYQ-tagged set — board-exam-pattern questions across grammar and
  // literature. Written fresh in the style of CBSE Class 10 English papers,
  // not copied from any official paper — see the `pyq` field comment.
  {
    id: 2001, ch: 1, subj: "english", diff: "medium", pyq: true,
    q: "Why does Lencho write his second letter to God, and what does its tone reveal about his character?",
    opts: [
      "To thank God — the tone shows gratitude",
      "To ask for exactly the amount lost — the tone shows quiet faith undimmed by hardship",
      "To accuse the post office of theft, in an angry tone",
      "To ask for more than he lost, in a greedy tone",
    ],
    ans: 2,
    exp: "Lencho's second letter angrily demands the rest of the money 'because the post office employees are a bunch of crooks,' revealing that his simple, unwavering faith in God coexists with a complete lack of trust in the people around him.",
  },
  {
    id: 2002, ch: 3, subj: "english", diff: "medium", pyq: true,
    q: "In 'Two Stories About Flying', what is the central emotion the mother bird has to overcome to teach her fledgling to fly?",
    opts: ["Anger", "Fear for the seagull's safety", "Jealousy", "Boredom"],
    ans: 1,
    exp: "The mother seagull has to fight her instinct to keep feeding and protecting her frightened fledgling, and instead push him to trust his own wings — the story frames this as a lesson about the fear that holds us back more than any real danger does.",
  },
  {
    id: 2003, ch: 9, subj: "english", diff: "medium", pyq: true,
    q: "What change does Kisa Gotami undergo after her encounter with the Buddha in 'The Sermon at Benares'?",
    opts: [
      "She becomes angry at the Buddha",
      "She realises death is universal and finds peace, later becoming a disciple",
      "She refuses to believe the Buddha and leaves",
      "She asks the Buddha to bring her son back to life a second time",
    ],
    ans: 1,
    exp: "Sent to find a mustard seed from a house untouched by death, Kisa Gotami cannot find one — realising death spares no household. This universalises her personal grief and she goes on to become one of the Buddha's followers.",
  },
  {
    id: 2004, ch: 12, subj: "english", diff: "medium", pyq: true,
    q: "In 'The Thief's Story', why does Hari Singh ultimately choose NOT to run away with Anil's money after stealing it?",
    opts: [
      "He is caught red-handed",
      "The money turns out to be counterfeit",
      "He realises Anil's trust and the chance to learn to read and write matter more than the money",
      "Anil offers him double the amount",
    ],
    ans: 2,
    exp: "Even after successfully stealing the notes, Hari Singh returns because Anil had trusted him and was teaching him to read and write — an opportunity he realises is worth more than five hundred rupees taken through betrayal.",
  },
  {
    id: 2005, ch: 13, subj: "english", diff: "medium", pyq: true,
    q: "What is ironic about the ending of 'The Midnight Visitor'?",
    opts: [
      "Ausable turns out to be the real spy",
      "The 'balcony' Fowler believes Max escaped onto doesn't exist — Ausable simply invented it to trick Max into leaving unarmed",
      "Fowler is actually the villain",
      "Max successfully escapes with the report",
    ],
    ans: 1,
    exp: "Ausable's room has no balcony at all — by calmly describing an imaginary one below Max's supposed escape route, he tricks Max into fleeing straight into the arms of the hotel's security, without ever needing a struggle.",
  },
  {
    id: 2006, ch: 16, subj: "english", diff: "medium", pyq: true,
    q: "What is the central message conveyed by the ending of 'The Necklace'?",
    opts: [
      "Hard work always makes people wealthy",
      "Borrowed appearances can exact a real and unexpected price, and pride can blind us to simpler truths",
      "Friends should never lend jewellery",
      "The poor are always dishonest",
    ],
    ans: 1,
    exp: "Mathilde's ten years of poverty were entirely unnecessary — a truth revealed only when it's too late — because her pride in appearing wealthy for one evening led her to hide the loss and replace the necklace rather than simply telling her friend the truth.",
  },
  {
    id: 2007, ch: 2, subj: "english", diff: "medium", pyq: true,
    q: "According to 'Nelson Mandela: Long Walk to Freedom', what does Mandela identify as the 'true test' of a person's commitment to freedom?",
    opts: [
      "Winning an election",
      "Not the absence of fear, but the courage to overcome it and continue the struggle",
      "Never experiencing hardship",
      "Being born free",
    ],
    ans: 1,
    exp: "Mandela explicitly says he learnt that courage is not the absence of fear but the triumph over it — the brave person is not one who feels no fear, but one who conquers it and keeps going.",
  },
  {
    id: 2008, ch: 1, subj: "english", diff: "easy", pyq: true,
    q: "Choose the option with the correct passive voice of: 'They are building a new bridge.'",
    opts: [
      "A new bridge was built by them.",
      "A new bridge is being built by them.",
      "A new bridge has been built by them.",
      "A new bridge is build by them.",
    ],
    ans: 1,
    exp: "Present continuous active ('are building') becomes present continuous passive: 'is/am/are + being + past participle' — so 'is being built'.",
  },
  {
    id: 2009, ch: 1, subj: "english", diff: "medium", pyq: true,
    q: "Identify the correctly punctuated and reported version of: Rahul said, \"I am going to the market now.\"",
    opts: [
      "Rahul said that he is going to the market now.",
      "Rahul said that he was going to the market then.",
      "Rahul said that I was going to the market now.",
      "Rahul told that he was going to the market then.",
    ],
    ans: 1,
    exp: "Reported speech shifts present continuous ('am going') to past continuous ('was going'), the pronoun 'I' to 'he', and the time word 'now' to 'then' — 'said' correctly takes 'that' without needing an object, unlike 'told'.",
  },
  {
    id: 2010, ch: 1, subj: "english", diff: "medium", pyq: true,
    q: "Fill in the blank with the correct modal: 'You ____ submit the form before Friday, it's compulsory.'",
    opts: ["might", "must", "could", "may"],
    ans: 1,
    exp: "'Must' expresses strong obligation/necessity, matching 'it's compulsory'. 'Might', 'could', and 'may' all express possibility, not obligation.",
  },
  {
    id: 2011, ch: 1, subj: "english", diff: "hard", pyq: true,
    q: "Choose the correctly formed question tag: 'She hardly ever visits her grandparents, ____?'",
    opts: ["doesn't she", "does she", "isn't she", "is she"],
    ans: 1,
    exp: "'Hardly ever' is a negative adverb, so the sentence is functionally negative even though it contains no 'not' — negative statements take a POSITIVE question tag: 'does she'.",
  },
  {
    id: 2012, ch: 1, subj: "english", diff: "medium", pyq: true,
    q: "Which sentence correctly uses a non-finite (infinitive) form to show purpose?",
    opts: [
      "She went to the market for buying vegetables.",
      "She went to the market to buy vegetables.",
      "She went to the market buying vegetables.",
      "She went to the market buy vegetables.",
    ],
    ans: 1,
    exp: "'To + base verb' (the infinitive of purpose) is the standard, correct way to express purpose in English — 'for buying' and the other options are non-standard here.",
  },
  {
    id: 2013, ch: 5, subj: "english", diff: "medium", pyq: true,
    q: "Which of these is highlighted as a distinctly Indian architectural/cultural feature in 'Glimpses of India'?",
    opts: [
      "Goan bread ('poder') traditions tied to community and celebration",
      "Only Mughal forts",
      "Only colonial-era buildings",
      "Exclusively South Indian temples",
    ],
    ans: 0,
    exp: "The Goa section of 'Glimpses of India' focuses on the village baker (poder) and how bread-making is woven into Goan social customs, celebrations, and even courtship rituals — one of the chapter's three regional glimpses (Goa, Assam/Coorg tea and coffee, Coorg culture).",
  },
  {
    id: 2014, ch: 8, subj: "english", diff: "medium", pyq: true,
    q: "In Chekhov's 'The Proposal', what is genuinely ironic about the arguments between Lomov and Natalya?",
    opts: [
      "They argue about who should propose first",
      "They fiercely argue over trivial matters (a disputed field, whose dog is better) even while Lomov has come specifically to propose marriage",
      "Natalya refuses to ever get married",
      "Lomov forgets why he came",
    ],
    ans: 1,
    exp: "The comedy's central irony is that Lomov arrives intending a simple, unemotional marriage proposal, but he and Natalya get so absorbed in petty disputes (over the Oxen Meadows, and whose dog is superior) that the actual proposal is repeatedly derailed by farce.",
  },
  {
    id: 2015, ch: 10, subj: "english", diff: "medium", pyq: true,
    q: "Which theme is common to most of the poems in the Class 10 'First Flight' poetry section, such as 'Dust of Snow' and 'Fire and Ice'?",
    opts: [
      "Simple everyday events or images carrying a larger reflection on life, mood, or human nature",
      "Detailed historical battles",
      "Instructions for gardening",
      "Purely humorous nonsense verse throughout",
    ],
    ans: 0,
    exp: "Poems like Frost's 'Dust of Snow' (a small moment with a crow and hemlock tree shifting the speaker's mood) and 'Fire and Ice' (weighing desire and hatred as forces of destruction) are typical of the collection's pattern: a compact, concrete image or moment opening onto a bigger reflection.",
  },
  {
    id: 2016, ch: 11, subj: "english", diff: "medium", pyq: true,
    q: "What allows the narrator in 'A Triumph of Surgery' to ultimately cure Tricki's illness?",
    opts: [
      "A rare surgical operation",
      "Simply stopping Mrs Pumphrey's overfeeding and putting Tricki on a strict, plain diet",
      "An expensive imported medicine",
      "Tricki is never actually cured",
    ],
    ans: 1,
    exp: "The 'surgery' of the ironic title is not a literal operation at all — Tricki's real ailment is simply overfeeding, and the cure is a period of enforced starvation and exercise at the vet's kennels, restoring him to health.",
  },
  {
    id: 2017, ch: 1, subj: "english", diff: "medium", pyq: true,
    q: "Which option correctly completes the sentence using an appropriate determiner: '____ of the students had submitted their assignment by the deadline.'",
    opts: ["Much", "Few", "Little", "Any"],
    ans: 1,
    exp: "'Students' is a countable plural noun, so 'few' (meaning 'not many, but some') fits correctly. 'Much' and 'little' are used with uncountable nouns, and 'any' doesn't fit the sentence's affirmative, quantity-describing structure here.",
  },
];
...
const BASE_ENG_SHORT_QA: ENGQA[] = [
  ...
  {
    id: 2001, ch: 4, subj: "english", marks: 2, pyq: true,
    q: "What does Anne Frank mean when she says she wants 'to go on living even after my death'? How does her diary help fulfil this?",
    a: "Anne means she wants to leave behind something of real, lasting value — not just be remembered, but to have actually contributed something meaningful through her writing. Her diary, written in hiding during the Holocaust, does exactly this: decades after her death, it is read worldwide as a powerful, deeply personal record of a young girl's inner life under persecution, giving her the very legacy she hoped for.",
  },
  {
    id: 2002, ch: 6, subj: "english", marks: 2, pyq: true,
    q: "Why does the author describe Mijbil the otter as an unusual but endearing house pet?",
    a: "Mijbil is a wild, playful, and mischievous animal quite unused to domestic life — he causes real chaos (flooding the bathroom, alarming strangers, wreaking havoc on a train journey) yet forms a close, affectionate, almost dog-like bond with the narrator. It's this combination of disruptive wildness and genuine devotion that makes him such an endearing, if unconventional, pet.",
  },
  {
    id: 2003, ch: 7, subj: "english", marks: 3, pyq: true,
    q: "What social message does 'Madam Rides the Bus' convey through Valli's bus journey?",
    a: "Through eight-year-old Valli's determined, independent bus trip, the story conveys that curiosity and the desire for new experiences are natural and valuable in children, and should not always be dismissed as childish. Valli's sharp observation, practical planning, and calm handling of the journey (even a dead calf on the road) show a child's capability for independence and maturity that adults often underestimate.",
  },
  {
    id: 2004, ch: 1, subj: "english", marks: 3, pyq: true,
    q: "Rewrite the following paragraph correcting the four errors in tense and subject-verb agreement: 'She go to school everyday. Yesterday, she meet her friend and they was play in the park.'",
    a: "Corrected: 'She goes to school every day. Yesterday, she met her friend and they were playing in the park.'\\nErrors corrected: (1) 'go' -> 'goes' (subject-verb agreement, third person singular present); (2) 'meet' -> 'met' (past tense, since 'yesterday' signals past time); (3) 'was' -> 'were' (agreement with plural subject 'they'); (4) 'play' -> 'playing' (past continuous form needed after 'were').",
  },
];
...
const BASE_ENG_LONG_QA: ENGQA[] = [
  ...
  {
    id: 2001, ch: 2, subj: "english", marks: 5, pyq: true,
    q: "'Long Walk to Freedom' is as much about the price of a divided society as it is about one man's journey.' Discuss Mandela's central ideas about freedom and courage with reference to the chapter.",
    a: "Nelson Mandela's autobiographical extract 'Long Walk to Freedom' is drawn from his speech after being sworn in as South Africa's first democratically elected President, and it works on two levels at once: it is deeply personal, tracing Mandela's own growth from a carefree boy in Transkei to a man who understood the true meaning of freedom, and it is deeply political, reflecting on what apartheid cost an entire nation.\n\nMandela describes twin obligations that every South African felt: to family and to country, to community and to fellow citizens. Growing up, he says, he was not born with a hunger for freedom — he was born free, in every way that mattered to a child, and only gradually discovered as a young man that this freedom was an illusion, granted only to whites. This realisation transformed his personal ambitions into a hunger for the freedom of his whole people.\n\nHe distinguishes carefully between different kinds of freedom — freedom from persecution, and the deeper freedom to live a life of dignity and self-respect. He argues that the oppressor is himself a prisoner of hatred and prejudice, robbed of his own humanity just as surely as the oppressed are robbed of theirs — 'the oppressor must be liberated just as surely as the oppressed,' he says, refusing to see freedom as a one-sided victory.\n\nMost memorably, Mandela redefines courage: not the absence of fear, but the triumph over it. He admits to feeling fear many times but learnt to hide it behind a mask of boldness, understanding that a leader's courage is measured not by fearlessness but by the ability to keep moving forward despite fear.\n\nFinally, he insists that his walk to freedom is not over even at his inauguration — that long walk has 'never ended,' since true freedom means ensuring the freedom of others too, an ongoing responsibility rather than a finished achievement. In this way the chapter moves from one man's memory into a universal statement about what real, shared freedom actually demands.",
  },
];
...
// ---------------------------------------------------------------------------
// Expansion merge point — see expansion-english.ts
// ---------------------------------------------------------------------------
export const ENG_MCQS: ENGMCQ[] = [...BASE_ENG_MCQS, ...EXTRA_ENG_MCQS];
export const ENG_SHORT_QA: ENGQA[] = [...BASE_ENG_SHORT_QA, ...EXTRA_ENG_SHORT_QA];
export const ENG_LONG_QA: ENGQA[] = [...BASE_ENG_LONG_QA, ...EXTRA_ENG_LONG_QA];
