...
import { EXTRA_SKT_MCQS, EXTRA_SKT_SHORT_QA } from "./expansion-sanskrit";
...
export interface SKTMCQ {
  ...
  ans: number;
  exp: string;
  /** Board-exam-pattern question, written in the style of CBSE Class 10 Sanskrit papers — not a literal transcription of an official paper. Grammar/vocabulary items are lower-risk for accuracy than chapter-narrative recall, so this set leans that way. */
  pyq?: boolean;
}
...
export const SKT_CHAPTERS: SKTChapter[] = [
  {
    ...
    keypts: [
      ...
      "Calling trees and rivers 'friends of life' (जीवनस्य मित्रे) signals a relationship of respect and reciprocity, not ownership — environmental care as a duty, not a modern borrowed idea.",
      "The imperative forms in वृक्षारोपणम् कुरुत, प्लास्टिकं वर्जयत shift the lesson from description to direct, memorable instruction — establish the problem, then command the fix.",
    ],
...
समास: (Compound)
  ...
  },
  {
    ...
    keypts: [
      ...
      "स्पृशति पाणिना demonstrates the instrumental case ('with the hand') — Sanskrit expresses 'the means by which an action happens' through case ending, not a preposition like English 'with'.",
      "स्वच्छता आरोग्यस्य अर्धम् uses the genitive case (आरोग्यस्य, 'of health') to state a general truth compactly — a construction that recurs throughout the syllabus's thematic chapters.",
    ],
...
समास: दन्तधावनम् = दन्तानां धावनम् (षष्ठी-तत्पुरुष:)`,
  ...
  },
  {
    ...
    keypts: [
      ...
      "गोदोहनम् is a compound of गो: (cow) + दोहनम् (milking) — recognising compounds like this makes vocabulary far easier to retain than memorising each word as opaque.",
      "The chapter's respect-for-labour theme (dignity of milking as daily work) reappears explicitly in परिश्रमः (Ch.11), tying rural life to the syllabus's broader thread on the nobility of everyday effort.",
    ],
...
समास: गोदोहनम् = गो: दोहनम् (षष्ठी-तत्पुरुष:)`,
  ...
  },
  {
    ...
    keypts: [
      ...
      "शिशु: क्रीडया शिक्षते uses the instrumental case again (क्रीडया, 'through play') — the same pattern as पाणिना in Ch.2, worth watching for throughout the syllabus.",
      "This chapter (how nurturing happens) sets up जननी तु गुरुः (Ch.5, why it matters) as a near-direct continuation rather than two unrelated topics.",
    ],
...
समास: लालन-गीतम् = लालनस्य गीतम् (षष्ठी-तत्पुरुष:)`,
  ...
  },
  {
    ...
    keypts: [
      ...
      "The particle तु in जननी तु गुरुः is doing real emphatic work — asserting the mother's role against an implicit assumption that 'guru' means a formal teacher, not just decorative phrasing.",
      "मातृदेवो भव is a direct Taittiriya Upanishad quotation — recognising quoted material explains why its phrasing feels more compressed than the surrounding descriptive prose.",
    ],
...
उपनिषद्-वाक्यम्:
  ...
  },
  {
    ...
    keypts: [
      ...
      "स्तबकः ('bouquet') is itself a metaphor — individual subhashitas as flowers gathered into one bunch, signalling a collection of unrelated short verses rather than one continuous narrative.",
      "Subhashitas pack complete moral ideas into one or two compressed lines, historically meant to be memorised and quoted in daily life rather than explained at length.",
    ],
...
सुभाषितम् (sample — public-domain):
  ...
  },
  {
    ...
    keypts: [
      ...
      "हिमालय: भारतस्य मुकुटम् इव uses इव ('like/as') to build a simile — spotting इव quickly is one of the most useful grammatical markers for reading Sanskrit prose.",
      "संस्कृति: राष्ट्रस्य आत्मा makes the chapter's real argument explicit: geography (rivers, mountains) matters here only because it shaped a culture — it's the culture that earns the pride.",
    ],
...
विशेषण-विशेष्यम् (adjective-noun agreement):
  ...
  },
  {
    ...
    keypts: [
      ...
      "The पञ्चमहाभूतानि (five great elements) frame pollution as disturbing a five-part cosmic balance, not just being 'bad for nature' in a generic sense.",
      "वायुदूषणं, जलदूषणं, भूमि-दूषणं all share दूषणम् (pollution/corruption) as their second half — recognising that shared piece lets you decode new pollution vocabulary without memorising each term separately.",
    ],
...
समास:
  ...
  },
  {
    ...
    keypts: [
      ...
      "वाक् (speech) and मनस् (mind) as 'twin rays' (मयूखौ) of one source is why the chapter treats controlling words and controlling thoughts as the same discipline, not two separate skills.",
      "वाचं मनसा शास्ति य: स सुधी: uses the instrumental (मनसा) again — the same 'means/tool' pattern seen in क्रीडया (Ch.4) and पाणिना (Ch.2).",
    ],
...
समास:
  ...
  },
  {
    ...
    keypts: [
      ...
      "अनया अकृतम्? is a rhetorical question implying its own answer ('she certainly has done it') — a persuasive technique worth recognising elsewhere in the syllabus too.",
      "Naming women across different eras and achievements (military, administration, poetry, politics) builds the case through breadth of example rather than resting on a single figure.",
    ],
...
समास:
  ...
  },
  {
    ...
    keypts: [
      ...
      "श्रम एव जयते uses एव ('alone/only') to rule out shortcuts explicitly — the claim is that labour is the *only* thing that truly wins, a stronger claim than 'labour helps'.",
      "Listing farmer, artisan, soldier and scholar together as equally noble argues dignity comes from effort itself, not profession prestige — echoing the same respect-for-labour theme as गोदोहनम् (Ch.3).",
    ],
...
सुभाषितम् (Hitopadesha, public-domain):
  ...
  },
  {
    ...
    keypts: [
      ...
      "The chapter moves from cosmic principle (वसुधैव कुटुम्बकम्, 'the whole earth is one family') down to social conclusion (division is मात्र अज्ञानम्, ignorance) — grand claim narrowing to practical implication.",
      "Calling division 'ignorance' rather than simply 'wrong' frames prejudice as a failure of understanding to correct, not a moral failing to punish — fitting the chapter's closing Upanishadic claims.",
    ],
...
const BASE_SKT_MCQS: SKTMCQ[] = [
  ...
  // ── PYQ-tagged set — deliberately grammar/vocabulary-focused (declension,
  // sandhi, basic conjugation) rather than deep chapter-narrative recall,
  // since these are the facts I can verify with confidence. Written fresh
  // in the style of CBSE Class 10 Sanskrit papers — see the `pyq` field note.
  {
    id: 2001, ch: 1, subj: "sanskrit", diff: "easy", pyq: true,
    q: "'वृक्ष' शब्दस्य चतुर्थी-विभक्ति: एकवचनम् किम्?",
    opts: ["वृक्षः", "वृक्षेण", "वृक्षाय", "वृक्षात्"],
    ans: 2,
    exp: "चतुर्थी-विभक्ति: (dative — 'to/for') अकारान्त-पुंलिङ्गशब्दानां एकवचने '-आय' प्रत्ययः भवति। अतः 'वृक्षाय' (to/for the tree) इति सम्यक् उत्तरम्।",
  },
  {
    id: 2002, ch: 2, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'फल' (नपुंसकलिङ्गम्) शब्दस्य प्रथमा-विभक्ति: बहुवचनम् किम्?",
    opts: ["फलः", "फलानि", "फलम्", "फलेन"],
    ans: 1,
    exp: "नपुंसकलिङ्गे अकारान्तशब्दानां प्रथमा/द्वितीया-विभक्तौ बहुवचने '-आनि' प्रत्ययः भवति — यथा 'फलानि', 'वनानि'। अतः 'फलानि' सम्यक्।",
  },
  {
    id: 2003, ch: 3, subj: "sanskrit", diff: "easy", pyq: true,
    q: "'राम' शब्दस्य द्वितीया-विभक्ति: एकवचनम् किम्?",
    opts: ["रामः", "रामम्", "रामेण", "रामाय"],
    ans: 1,
    exp: "द्वितीया-विभक्ति: (accusative — कर्मकारकः) अकारान्त-पुंलिङ्गशब्दानां एकवचने '-अम्' प्रत्ययः भवति। अतः 'रामम्' सम्यक् उत्तरम्।",
  },
  {
    id: 2004, ch: 4, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'देव + इन्द्रः' इत्यत्र का सन्धिः भवति?",
    opts: ["गुण-सन्धिः (देवेन्द्रः)", "वृद्धि-सन्धिः (देवैन्द्रः)", "यण्-सन्धिः (देव्येन्द्रः)", "कोऽपि सन्धिः न भवति"],
    ans: 0,
    exp: "अ/आ + इ/ई → ए (गुण-सन्धिः)। 'देव' इत्यस्य अन्तिमः 'अ' तथा 'इन्द्रः' इत्यस्य आदिः 'इ' मिलित्वा 'ए' भवति — 'देवेन्द्रः'।",
  },
  {
    id: 2005, ch: 4, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'सूर्य + उदयः' इत्यत्र सन्धि-नियमः कः?",
    opts: ["अ/आ + उ/ऊ → ओ (गुण-सन्धिः), अतः 'सूर्योदयः'", "अ/आ + उ/ऊ → औ (वृद्धि-सन्धिः)", "उ + अ → व (यण्-सन्धिः)", "कोऽपि परिवर्तनं न भवति"],
    ans: 0,
    exp: "अ/आ + उ/ऊ → ओ इति गुण-सन्धि-नियमेन 'सूर्य' + 'उदयः' मिलित्वा 'सूर्योदयः' (sunrise) भवति।",
  },
  {
    id: 2006, ch: 5, subj: "sanskrit", diff: "easy", pyq: true,
    q: "'पठ्' धातोः लट्-लकारे प्रथम-पुरुषे एकवचनं किम्?",
    opts: ["पठामि", "पठसि", "पठति", "पठन्ति"],
    ans: 2,
    exp: "लट्-लकारः (present tense) — प्रथम-पुरुष-एकवचनम् (he/she reads) 'पठति' भवति। पठामि = उत्तम-पुरुषः (I read); पठसि = मध्यम-पुरुषः (you read)।",
  },
  {
    id: 2007, ch: 6, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'गम्' धातोः लट्-लकारे प्रथम-पुरुष-एकवचनं किम्?",
    opts: ["गमति", "गच्छति", "गमयति", "गन्ता"],
    ans: 1,
    exp: "'गम्' धातोः लट्-लकारे धातु-रूपम् 'गच्छ्' इति भवति (गम्→गच्छ्), अतः प्रथम-पुरुष-एकवचनम् 'गच्छति' (he/she goes)।",
  },
  {
    id: 2008, ch: 7, subj: "sanskrit", diff: "easy", pyq: true,
    q: "'तत्' सर्वनाम्नः पुंलिङ्गे प्रथमा-विभक्तौ एकवचनं किम्?",
    opts: ["तम्", "सः", "तेन", "तस्मै"],
    ans: 1,
    exp: "'तत्' (that) सर्वनाम्नः पुंलिङ्गे प्रथमा-विभक्तौ एकवचनं 'सः' (he/that) भवति — अतीव प्रचलितं रूपम्।",
  },
  {
    id: 2009, ch: 3, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'गोदोहनम्' इति शब्दस्य समास-विग्रहः / अर्थः कः?",
    opts: ["गवां गृहम् (the cows' house)", "गोः दोहनम् — गाः दुग्धं निष्कासनम् (the milking of the cow)", "गवां क्रीडनम् (the play of cows)", "गवां भोजनम् (the food of cows)"],
    ans: 1,
    exp: "'गो' = गौः (cow), 'दोहनम्' = दुह्-धातोः (to milk) — 'गोदोहनम्' इत्यस्य अर्थः 'गाः दुग्धं निष्कासनकार्यम्' (the act of milking the cow)।",
  },
  {
    id: 2010, ch: 11, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'परिश्रमः' इति शब्दस्य अर्थः कः?",
    opts: ["विश्रामः (rest)", "कठिनं कार्यम् / अध्यवसायः (hard work / diligent effort)", "क्रीडा (play/game)", "निद्रा (sleep)"],
    ans: 1,
    exp: "'परि' (thoroughly) + 'श्रम' (exertion) = 'परिश्रमः' इत्यस्य अर्थः कठिनं, अध्यवसायपूर्णं कार्यम् (diligent hard work) भवति — पाठस्य शीर्षकमपि एतदेव सूचयति।",
  },
  {
    id: 2011, ch: 5, subj: "sanskrit", diff: "easy", pyq: true,
    q: "'जननी तु गुरुः' इति वाक्यस्य आशयः कः?",
    opts: ["माता एव प्रथमा गुरुः/शिक्षिका भवति", "पिता एव गुरुः भवति", "गुरुः एव माता भवति", "विद्यालयः एव गुरुः भवति"],
    ans: 0,
    exp: "'जननी' = माता, 'गुरुः' = शिक्षकः। 'जननी तु गुरुः' इत्यनेन उच्यते यत् माता एव बालकस्य प्रथमा तथा महत्त्वपूर्णा गुरुः भवति।",
  },
  {
    id: 2012, ch: 12, subj: "sanskrit", diff: "medium", pyq: true,
    q: "'विश्वबन्धुत्वम्' इति शब्दस्य अर्थः कः?",
    opts: ["एकस्य देशस्य प्रेम", "सम्पूर्णविश्वस्य बन्धुत्वभावः / सर्वे जनाः बन्धुसमानाः (universal brotherhood — all people as kin)", "केवलं मित्राणां सङ्घः", "विश्वयुद्धम्"],
    ans: 1,
    exp: "'विश्व' = सम्पूर्णं जगत्, 'बन्धुत्वम्' = बन्धु-भावः (kinship)। अतः 'विश्वबन्धुत्वम्' इत्यस्य अर्थः सम्पूर्णविश्वे सर्वेषां जनानां बन्धुत्व-भावना (all people of the world as kin) भवति।",
  },
];
...
const BASE_SKT_SHORT_QA: SKTQA[] = [
  ...
  {
    id: 2001, ch: 5, subj: "sanskrit", marks: 2, pyq: true,
    q: "संस्कृतभाषायां अनुवादं कुरुत — 'I read a book daily.' तथा प्रयुक्तं लकारं, पुरुषं, वचनं च लिखत।",
    a: "अनुवाद: — 'अहं प्रतिदिनं पुस्तकं पठामि।'\n\nव्याकरण-विश्लेषणम्:\n  धातु: — पठ् (to read)\n  लकार: — लट्-लकार: (present tense)\n  पुरुष: — उत्तम-पुरुष: (first person, since 'I' = अहम्)\n  वचनम् — एकवचनम् (singular)\n  रूपम् — पठामि (I read)\n\nहिंदी: अनुवाद — 'अहं प्रतिदिनं पुस्तकं पठामि।' यहाँ 'पठ्' धातु का लट्-लकार, उत्तम पुरुष, एकवचन रूप 'पठामि' प्रयुक्त हुआ है।",
  },
  {
    id: 2002, ch: 6, subj: "sanskrit", marks: 2, pyq: true,
    q: "'सः विद्यालयं गच्छति।' इति वाक्ये प्रत्येकं पदं पृथक् कृत्वा अर्थं लिखत।",
    a: "पद-विच्छेद: तथा अर्थ:\n  सः — वह/He (सर्वनाम, प्रथमा-विभक्ति:, एकवचनम्)\n  विद्यालयम् — school/विद्यालय को (द्वितीया-विभक्ति:, एकवचनम् — कर्मकारकः)\n  गच्छति — जाता है/goes (गम्-धातु:, लट्-लकार:, प्रथम-पुरुष:, एकवचनम्)\n\nसम्पूर्ण-अर्थ: — 'He goes to school.' / 'वह विद्यालय जाता है।'\n\nनोट: 'गम्' धातोः लट्-लकारे धातु-रूपम् 'गच्छ्' भवति, अतः 'गच्छति' न तु 'गमति'।",
  },
];
...
// ---------------------------------------------------------------------------
// Expansion merge point — see expansion-sanskrit.ts
// ---------------------------------------------------------------------------
export const SKT_MCQS: SKTMCQ[] = [...BASE_SKT_MCQS, ...EXTRA_SKT_MCQS];
export const SKT_SHORT_QA: SKTQA[] = [...BASE_SKT_SHORT_QA, ...EXTRA_SKT_SHORT_QA];
export const SKT_LONG_QA: SKTQA[] = BASE_SKT_LONG_QA; // unexpanded — grammar/paragraph-writing focus went into SHORT_QA instead
