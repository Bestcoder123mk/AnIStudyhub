...
// A flavour title per level — shown on level-up, and next to a student's
// name wherever their equipped title (from the Shop) isn't set. Purely
// cosmetic, but a big part of what makes leveling up feel like *something*
// instead of just a number ticking up.
const LEVEL_TITLES = [
  "Newcomer", "Rising Scholar", "Diligent Student", "Focused Learner",
  "Sharp Mind", "Dedicated Scholar", "Top of the Class", "Subject Specialist",
  "Exam Strategist", "Distinction Scholar", "Board Topper", "Academic Ace",
  "Master Scholar", "Grandmaster", "Legend", "Hall of Fame",
];
