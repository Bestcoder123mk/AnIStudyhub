...
export function getAllTrackMcqs(track: Track): TrackMCQ[] {
  if (track === "science") return MCQS;
  if (track === "ssc") return SSC_MCQS;
  if (track === "maths") return MATHS_MCQS;
  if (track === "english") return ENG_MCQS;
  return SKT_MCQS;
}
